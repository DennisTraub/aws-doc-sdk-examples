...
{
    [Fact]
    public async Task ConverseDocumentScenarioReturnsSingleTextBlock()
    {
        var response = await MultimodalWithDocument.Converse();
    ...
    [Fact]
    public async Task ConverseStreamDocumentScenarioReturnsHttpOk()
    {
        var response = await MultimodalWithDocument.ConverseStream();
